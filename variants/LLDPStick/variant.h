...
#define PIN_SPI_MISO         (3) // P0.3
#define PIN_SPI_MOSI         (2) // P0.2
#define PIN_SPI_SCK          (4) // P0.4

static const uint8_t SS   = 5 ;  // P0.5
...
#define PIN_WIRE_SDA         (12u) // P0.12
#define PIN_WIRE_SCL         (11u) // P0.11
